import { Font, Template, checkTemplate } from '@appsafetyhub/generator';
...
export const getGeneratorSampleCode = (template: Template) =>
  `import { generate } from "@appsafetyhub/generator";
...
export const getFormSampleCode = (template: Template) =>
  `import { Form } from "@appsafetyhub/ui";
...
export const getViewerSampleCode = (template: Template) =>
  `import { Viewer } from "@appsafetyhub/ui";
